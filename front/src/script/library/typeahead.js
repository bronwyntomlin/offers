        ...
        s = function() {
            ...
            return {
                ...
                trigger: function(n) {
                    ...
                    for (;
                        (s = n.shift()) && (r = this._callbacks[s]);) o = i(r.sync, this, [s].concat(a)), u = i(r.async, this, [s].concat(a)), o() && e(u);
                    return this
                }
            };
        ...
        r = function(t) {
            ...
            return function(i) {
                ...
                (i = e.mixin({}, n, i)).node && i.pattern && (i.pattern = e.isArray(i.pattern) ? i.pattern : [i.pattern], s = function(t, n, i) {
                    for (var s, r = [], a = 0, o = t.length; a < o; a++) r.push(e.escapeRegExChars(t[a]));
